package com.example.searchplacement.presentation.owner.reservation
...
import com.example.searchplacement.presentation.user.reserve.my.InfoItem
import com.example.searchplacement.presentation.user.reserve.my.InfoRow
import com.example.searchplacement.presentation.utils.parseReservationDateTime

@Composable
fun OwnerReservedList(
    ...
    val (statusText, statusBgColor, statusTextColor) = when (reservation.status) {
        ...
        "cancelled" -> Triple("예약 취소", ChipBorderColor, RedPoint)
        else -> Triple("알 수 없음", LightGray, DarkGray)
    }
