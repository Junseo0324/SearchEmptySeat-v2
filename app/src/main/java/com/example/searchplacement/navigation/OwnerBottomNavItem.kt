...
sealed class OwnerBottomNavItem(
    ...
    object Home : OwnerBottomNavItem("매장 관리", Icons.Outlined.Home, Icons.Filled.Home, "owner_home")
    object Store : OwnerBottomNavItem("메뉴 관리", Icons.Outlined.Store, Icons.Filled.Store, "owner_store")
